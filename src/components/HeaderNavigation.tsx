    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <nav
            className={`fixed inset-0 z-40 w-full h-screen bg-bg-4/95 backdrop-blur-sm flex flex-col gap-6 text-base tracking-[0.1em] px-6 pt-20 pb-8 pr-16 transition-all duration-300 overflow-y-auto ${
              isMobileMenuOpen
