      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16 text-left">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 leading-relaxed text-justify">
            <p>
              Rues Vertes — бренд одежды для креаторов и предпринимателей, основанный Элеонорой Григорян{"\u00a0"}в 2025 году. Наш бренд — это территория для тех, кто мыслит иначе. Мы объединяем работников креативной индустрии, вдохновляя их выражать свою индивидуальность и приверженность{"\u00a0"}к творческому сообществу. Rues Vertes — это настоящее коммьюнити, где мода встречается с креативом, а стиль становится способом говорить о себе громко и уверенно. Мы верим, что одежда — это язык самовыражения. Наши вещи созданы для тех, кто живёт идеями, создаёт смыслы и делает мир вокруг ярче.
            </p>
            <p>
              Каждая коллекция Rues Vertes является лимитированной, а изделия из премиальных материалов доставляются в кастомных деревянных боксах с нанесением граффити и подписанной вручную открыткой. Наши изделия уникальны: они совмещают повседневный casual с нестандартностью и принадлежностью{"\u00a0"}к коммьюнити молодых креаторов. Наша глобальная миссия — объединить всех креаторов, создавая для них уникальный способ заявить о себе.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-6 leading-relaxed text-justify">
            <div>
              ...
              <p>
                Мы используем только проверенные материалы и работаем с лучшими производителями, чтобы каждое изделие служило вам долгие годы.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-lg mb-2">Честность</h3>
              <p>
                Прозрачность на всех этапах — от выбора материалов до финальной цены. Мы открыто рассказываем{"\u00a0"}о том, как и где производится наша продукция.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-lg mb-2">Устойчивость</h3>
              <p>
                Забота об окружающей среде — это не опция, а необходимость. Мы выбираем экологичные материалы, чтобы минимизировать отходы производства.
              </p>
            </div>
            <div>
